...
# Per-task sub-score ceilings, keyed by (question_type, MAX_MARK).
#
# The mark is part of the key because the same task name carries a different
# ceiling in different papers: a Class XI Summary is out of 10, a Class VII
# Summary out of 5, and their sub-score splits are not proportional. Each row
# must sum to its MAX_MARK — asserted by tests at import time below.
#
# An ITEM-SCORED question (the Class VII reading questions) puts its whole mark
# in context_content_data and fixes the other three criteria at 0: there is no
# "structure" or "originality" in a right-or-wrong MCQ item.
SUBSCORE_CEILINGS: dict[tuple[str, int], dict[str, int]] = {
    # ---- Class XI (SE_11_Q1), extended response -------------------------
    ("Paragraph", 10):    {"context_content_data": 3, "structure_format_brevity": 3,
                           "language_mechanics": 2, "originality_comparisons_paraphrase": 2},
    ("Summary", 10):      {"context_content_data": 3, "structure_format_brevity": 2,
                           "language_mechanics": 2, "originality_comparisons_paraphrase": 3},
    ("Graph_Chart", 10):  {"context_content_data": 3, "structure_format_brevity": 3,
                           "language_mechanics": 2, "originality_comparisons_paraphrase": 2},
    ("Theme", 8):         {"context_content_data": 3, "structure_format_brevity": 2,
                           "language_mechanics": 1, "originality_comparisons_paraphrase": 2},
    ("Story", 7):         {"context_content_data": 2, "structure_format_brevity": 2,
                           "language_mechanics": 1, "originality_comparisons_paraphrase": 2},
    ("Letter_Email", 5):  {"context_content_data": 1, "structure_format_brevity": 2,
                           "language_mechanics": 1, "originality_comparisons_paraphrase": 1},
    # ---- Class VII (SE_07_Q1), item-scored reading ----------------------
    ("MCQ", 7):                     {"context_content_data": 7, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Short_Answer", 10):           {"context_content_data": 10, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Gap_Fill", 5):                {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Vocabulary", 5):              {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Table_Completion", 5):        {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("True_False", 5):              {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Sentence_Transformation", 5): {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Rearrange", 8):               {"context_content_data": 8, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Poem_Short_Answer", 5):       {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    # ---- Class VI (SE_06_Q1), item-scored reading -----------------------
    # Same shape as Class VII but the marks differ: Q2 is 1x5 here (not 2x5),
    # Q10 is 2x5 (not 1x5), and Q8 asks for composed sentences, not transforms.
    ("Short_Answer", 5):            {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Preposition_Use", 5):         {"context_content_data": 5, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    ("Poem_Short_Answer", 10):      {"context_content_data": 10, "structure_format_brevity": 0,
                                     "language_mechanics": 0, "originality_comparisons_paraphrase": 0},
    # ---- Class VII (SE_07_Q1), extended response ------------------------
    ("Summary", 5):       {"context_content_data": 2, "structure_format_brevity": 1,
                           "language_mechanics": 1, "originality_comparisons_paraphrase": 1},
    ("Story", 10):        {"context_content_data": 3, "structure_format_brevity": 3,
                           "language_mechanics": 2, "originality_comparisons_paraphrase": 2},
    ("Dialogue", 10):     {"context_content_data": 3, "structure_format_brevity": 3,
                           "language_mechanics": 2, "originality_comparisons_paraphrase": 2},
}

# The Class VI/VII reading questions: marked item-by-item against an answer key,
# so only context_content_data can be non-zero and no structural cap ever
# applies.
ITEM_SCORED_TYPES = {
    "MCQ", "Short_Answer", "Gap_Fill", "Vocabulary", "Table_Completion",
    "True_False", "Sentence_Transformation", "Preposition_Use", "Rearrange",
    "Poem_Short_Answer",
}


def ceilings_for(question_type: str, max_mark: int) -> dict[str, int]:
    """Sub-score ceilings for one task, or {} if the pair is unknown."""
    return SUBSCORE_CEILINGS.get((question_type, max_mark), {})


# Standard cap = 50% of MAX_MARK rounded down.
STANDARD_CAP = {10: 5, 8: 4, 7: 3, 5: 2}

# Structural caps as a FRACTION of MAX_MARK, by applied_cap_reason. A fraction
# rather than a fixed number because the same cap has to land correctly on a
# 10-mark Class XI summary (5) and a 5-mark Class VII summary (2). These
# reproduce the previously hard-coded Class XI values exactly.
CAP_FRACTIONS: dict[str, float] = {
    "Paragraph_Subdivisions": 0.5,      # 10 -> 5
    "Letter_Missing_Layout": 0.5,       #  5 -> 2
    "Summary_Verbatim_Length": 0.5,     # 10 -> 5,  5 -> 2
    "Theme_Verbatim_Copy": 0.5,         #  8 -> 4
    "Dialogue_Format_Missing": 0.5,     # 10 -> 5
    "Graph_External_Facts": 0.6,        # 10 -> 6 (deliberate rubric exception)
}


def cap_value(reason: str, max_mark: int) -> int | None:
    """The total_score ceiling this cap reason imposes, or None for no cap."""
    if reason in ("None", "", None):
        return None
    frac = CAP_FRACTIONS.get(reason)
    if frac is None:
        return None
    return int(max_mark * frac)
